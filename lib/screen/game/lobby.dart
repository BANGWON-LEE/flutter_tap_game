...
class _LobbyState extends State<Lobby> {
  ...
  void getUserRecordHttp() async {
    ...
    recentRecord = recntRcRecord == null ? null : '${recntRcRecord! ~/100}.${'${recntRcRecord! % 100}'.padLeft(2, '0')}';
  ...
  void getMyRank() async{
    ...
    try {
      ...
      final res = await dio.post("/api/record/level1/my/rank",  data: {"mem_id": prefs.getInt('memId')} );
